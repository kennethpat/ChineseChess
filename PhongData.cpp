...
void MySetupLights()
{
    ...
    myLights[1].DiffuseColor.Set(0.8, 0.8, 0.8);      // Very light gray
    myLights[1].SpecularColor.Set(0.9, 0.9, 0.9);   // Very light gray
    myLights[1].IsEnabled = true;                   // BE SURE TO ENABLE YOUR LIGHTS
    
    myLights[2].AmbientColor.Set(0.2, 0.2, 0.2);    // Gray color
    myLights[2].DiffuseColor.Set(0.8, 0.8, 0.8);      // Very light gray
    myLights[2].SpecularColor.Set(0.9, 0.9, 0.9);   // Very light gray
